...
from bytedigger_engine.config_provider import hal_root as _hal_root_fn, path as _path_fn, incident_log_relpath, foreign_state_dirname as _foreign_state_dirname_fn  # noqa: E402
    ...
    *,
    ...
    try:
        ...
        if events_path is not None:
            try:
                from bytedigger_engine.lib.cost_rollup import compute_cost_rollup  # noqa: PLC0415
