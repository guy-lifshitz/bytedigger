...
def resolve_durable_backend(
    *, event_log_path: str | None = None, run_id: str | None = None
    ...
    """
    from bytedigger_engine.config_provider import env_opt  # local import — keeps this module import-light
...
def execute_engine(
    ...
    from bytedigger_engine.event_log import EventLog  # noqa: F401 — kept; used elsewhere in module
