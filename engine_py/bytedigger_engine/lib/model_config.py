...
from bytedigger_engine.config_provider import models_config_path as _models_config_path  # noqa: E402
...
def is_model_unavailable(model: str, provider: str = "claude") -> bool:
    ...
    from bytedigger_engine.lib.llm_provider import _claude_model_family
