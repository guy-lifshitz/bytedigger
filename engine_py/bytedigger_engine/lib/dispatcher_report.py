...
from bytedigger_engine.config_provider import hal_root as _hal_root_fn, path as _path_fn, foreign_state_dirname as _foreign_state_dirname_fn, env_opt as _env_opt_fn  # noqa: E402
...
def default_dispatcher_index_path() -> Path:
    ...
    try:
        ...
        if cwd == hal_dir or cwd.is_relative_to(hal_dir):
            from bytedigger_engine.config_provider import dispatcher_reports_relpath as _dispatcher_reports_relpath_fn  # noqa: PLC0415
