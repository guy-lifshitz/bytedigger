...
from bytedigger_engine.lib.cost_rollup import compute_cost_rollup, annotate_invocation
from bytedigger_engine.lib.env_limit import is_paused_result
from bytedigger_engine.lib.spec_defect_ledger import mark_reroute_consumed, reroute_already_consumed
from bytedigger_engine.lib.incident_ledger import emit_incident
from bytedigger_engine.lib.dispatcher_report import emit_dispatcher_report
from bytedigger_engine.lib.stuck_report import build_stuck_report, emit_stuck_report
...
def _resolve_engine_version() -> str:
    ...
    try:
        ...
        pass
    try:
        # bd#44: this module now lives one level deeper, inside the
        # `bytedigger_engine` package, so engine_py/pyproject.toml is two hops up.
