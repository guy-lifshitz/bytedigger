...
from bytedigger_engine.config_provider import hal_root as _hal_root_fn
from bytedigger_engine.lib.timeout_policy import classify_timeout_state, resolve_active_threshold_bytes
from bytedigger_engine.lib.llm_provider import get_provider  # GH451: provider seam (build_argv/parse_result/rank/family/floor)
from bytedigger_engine.lib.llm_provider import _claude_model_family  # bd#10 AC-M4: the external family ladder
...
from bytedigger_engine.lib.llm_provider import _is_fable_model, _is_opus_model  # noqa: E402
