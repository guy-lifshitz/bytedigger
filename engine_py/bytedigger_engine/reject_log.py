...
from bytedigger_engine.config_provider import hal_root as _hal_root_fn, path as _path_fn, reject_log_relpath, foreign_state_dirname as _foreign_state_dirname_fn  # noqa: E402
...
def emit_reject_reason(
    ...
    *,
    ...
    try:
        ...
        if build_id is None:
            try:
                from bytedigger_engine import telemetry_ctx  # lazy import — module may be absent in test env
