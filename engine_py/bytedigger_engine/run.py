...
try:
    from bytedigger_engine.lib.reference_backends import anthropic_api as _anthropic_api_backend_mod  # noqa: F401  — #302 reference backend
...
try:
    from bytedigger_engine.lib.reference_backends import pydantic_openai as _pydantic_openai_backend_mod  # noqa: F401  — GH851 reference backend
...
try:
    from bytedigger_engine.lib.reference_backends import pydantic_anthropic as _pydantic_anthropic_backend_mod  # noqa: F401  — GH860 reference backend
...
try:
    from bytedigger_engine.lib.reference_backends import agent_sdk as _agent_sdk_backend_mod  # noqa: F401  — GH885 reference backend
...
def _oracle_entry_verify(args, ctx, run_id: str) -> "StepResult | None":
    ...
    from bytedigger_engine.conformance import oracle  # noqa: PLC0415 — deferred; §1f keeps run.py thin
...
def _oracle_after_execute(args, ctx, run_id: str, result) -> "StepResult | None":
    ...
    """
    from bytedigger_engine.conformance import oracle  # noqa: PLC0415 — deferred; §1f
