...
from bytedigger_engine.lib.git_cwd import resolve_git_cwd, resolve_git_cwd_with_source, is_ambient_git_cwd  # noqa: E402  GH381/GH449/GH1220
...
from bytedigger_engine.lib.spec_defect_ledger import (  # noqa: E402  GH767 §2.2/§2.4b
    attempts_floor,
...
# checkout pollution).
from bytedigger_engine.lib.run_allowlist import parse_spec_files_allowlist as _parse_spec_files_allowlist  # noqa: E402
...
from bytedigger_engine.lib.run_allowlist import parse_authorized_test_edits as _parse_authorized_test_edits  # noqa: E402
# GH639 (7C0FDE44): reason-aware sibling of _parse_authorized_test_edits.
from bytedigger_engine.lib.run_allowlist import parse_authorized_test_edits_with_reasons as _parse_authorized_test_edits_with_reasons  # noqa: E402

# GH569: same re-export pattern — derived test-scope helpers, canonical in
# lib.run_allowlist (§1g single source).
from bytedigger_engine.lib.run_allowlist import is_test_shaped as _is_test_shaped  # noqa: E402
from bytedigger_engine.lib.run_allowlist import derived_test_scope_match as _derived_test_scope_match  # noqa: E402
...
def _verify_security_lint(ctx, prev) -> StepResult:
    ...
    script = Path(cfg.get("security_lint_script") or default_security_asset("security_lint.py", Path(__file__).parents[3] / "security-lint.py"))
    if not script.is_file():
        return StepResult(
            status="error", data=None, duration_ms=0, step_name=step,
...
from bytedigger_engine.lib.mypy_baseline import (  # noqa: E402
