...
try:
    ...
    from bytedigger_engine.workflows.phase_workflows_common import _emit_safe  # type: ignore[no-redef]  # noqa: E402
try:
    from .phase_6_review import _autocommit_fix_tail  # noqa: E402  GH886 Change 1
except ImportError:  # pragma: no cover — bare fallback for sys.path-rooted test imports (GH881)
    from bytedigger_engine.workflows.phase_6_review import _autocommit_fix_tail  # type: ignore[no-redef]  # noqa: E402
