...
from bytedigger_engine.lib.model_config import get_claude_critical, get_claude_spec_writer, get_claude_spec_reviewer
...
try:
    ...
    from bytedigger_engine.workflows.phase_45_spec import (  # type: ignore[no-redef]
        _verify_spec_cite_prelint,
        _verify_spec_completeness,
        _verify_spec_lint,
    )
from bytedigger_engine.skip_logic import detect_frozen_spec
...
from bytedigger_engine.lib.spec_retry_cycle import (  # CF480CAE SSOT-01
    truncate_findings,
    resolve_command,
    resolve_model,
