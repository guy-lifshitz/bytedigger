...
try:
    ...
    from bytedigger_engine.workflows.phase_0_6_artifact_detect import _detect_artifact  # type: ignore[no-redef]
try:
    from .phase_5_devops_scan import _scan_artifact
except ImportError:  # pragma: no cover — bare fallback for sys.path-rooted test imports (GH881)
    from bytedigger_engine.workflows.phase_5_devops_scan import _scan_artifact  # type: ignore[no-redef]
