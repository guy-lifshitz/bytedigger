...
from llm_subprocess import invoke_llm_subprocess  # noqa: F401
...
import lib.authored_boundary as _authored_boundary
...
def _resolve_directed_repair_model(cfg: dict | None) -> str:
    ...
    import model_config
    from lib.observability import emit_resolver
