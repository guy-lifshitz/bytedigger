...
from contracts import RetryPolicy, StepContract, StepResult, WorkflowDefinition, step
from llm_subprocess import invoke_llm_subprocess, STRAGGLER_PATIENCE_SEC, STRAGGLER_POLL_INTERVAL_SEC, manifest_from_result, _ManifestMissingError, _ManifestError, prev_data_corruption_reason, _resolve_backend
...
from anti_hallucination.semantic_verifier import (  # noqa: E402
    verify_findings_semantic as _verify_findings_semantic_impl,
)
from model_config import get_claude_critical, get_claude_primary, get_claude_decorrelated_verifier  # noqa: E402
...
from plugins.disk_truth import git_diff_files, resolve_pre_phase_sha, run_test_command, parse_structured_block, enforce, SatisfactionVerdict, FixVerdict, SchemaViolation  # noqa: E402
from plugins.review_schema import (  # noqa: E402  812D2503 Ship B: canonical schema source
...
from net_new_delta import delta_verdict  # noqa: E402  GH316 post-fix typecheck gate
from lib.mypy_baseline import mypy_base_argv as _mypy_base_argv_p6, parse_mypy_output as _parse_mypy_output_p6  # noqa: E402  GH316
from config_provider import timeout_policy_path, state_dir_prefix  # noqa: E402  GH285 C2
...
def _build_review_prompt(ctx, _prev) -> StepResult:
    ...
    if _read_engine_mode(str(spec_path)) == "test_only":
        parts.append("")
        parts.append(
            "## TEST-ONLY BUILD\n"
            "\n"
...
from config_provider import get_config  # noqa: E402  GH373 §2 Part A
