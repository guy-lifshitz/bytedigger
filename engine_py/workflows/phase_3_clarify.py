...
_sys.path.insert(0, str(Path(__file__).parent.parent / "lib" / "plugins"))
...
from anti_hallucination.helper import get_out_of_role_block as _get_out_of_role_block  # noqa: E402
