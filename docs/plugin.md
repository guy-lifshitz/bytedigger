# ByteDigger as a Claude Code plugin

Full reference for the Claude Code orchestration layer: 9 phases, gate-enforced, TDD mandatory. For the standalone Python engine see the [main README](../README.md) and [engine_py/](../engine_py/).

> [How we automated ourselves out of code review](article.md) -- the full story behind this pipeline.
...
- `metadata` (object, optional) — Contextual details (see `events.md`)
...
See [events.md](events.md) for complete event schema, metadata vocabulary, HAL mapping semantics, and wiring architecture.
...
- [How we automated ourselves out of code review](article.md) -- the full story
